...
<core:url value="/admin/question-insert" var="insert" />
	...
	<div class="row">
		<div class="col-xl-12">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<frm:form action="${insert}" modelAttribute="question"
						id="question-form">
						<div class="row">
							<div class="col-md-6">
								<!-- Employee name -->
								...
								<div id="answerWrapper" class="mb-4">
									<ul class="list-group" id="answer_container">
										<li class="list-group-item d-flex align-items-center"
											...
											<div class="ml-auto">
												<input type="radio" name="answer_status" checked>
											</div></li>
										<li class="list-group-item d-flex align-items-center"
											id="item-clone"><div class="cancle mr-3">
												<i class="fas fa-times"></i>
							...
							<button type="submit" class="btn btn-primary ml-2 my-4">Create
								Question</button>
						</div>
					</frm:form>
				</div>
