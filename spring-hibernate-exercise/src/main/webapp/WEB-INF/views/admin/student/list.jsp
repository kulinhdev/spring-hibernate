...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="${rootpath}admin/student-create"
			class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			class="fas fa-plus  fa-sm text-white-50"></i> Add New Student</a>
	</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered text-left" id="dataTable"
								...
								<tbody>
									<core:forEach items="${listStudents}" var="student"
										varStatus="loop">
										<tr>
											<th scope="row">${loop.count}</th>
											<td>${student.name}</td>
											<td><img width="60px"
												src="${rootpath}public/uploads/${student.avatar}"
												alt="${student.name}" /></td>
											<td>${student.phone}</td>
											...
											<td>${student.status ? "Active" : "Disable"}</td>
											<td><div class="d-flex">
													<a href="${rootpath}admin/student-edit/${student.id}"
														...
														<div class="modal-dialog" role="document">
															<div class="modal-content">
																...
																<div class="modal-body">Do you want to delete this
																	record with id: ${student.id} ?</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary"
																		data-dismiss="modal">Close</button>
																	<a href="${rootpath}admin/student-delete/${student.id}"
