...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">List Employees</h1>
		<a href="${rootpath}admin/employee-create"
			class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			class="fas fa-plus  fa-sm text-white-50"></i> Add New Employee</a>
	</div>
								...
								<tbody>
									<core:forEach items="${listEmployees}" var="employee"
										...
										<tr>
											...
											<td>${employee.name}</td>
											<td><img width="60px"
												src="${rootpath}public/uploads/${employee.avatar}"
												alt="${employee.name}" /></td>
											...
											<td>${employee.status ? "Active" : "Disable"}</td>
											<td><div class="d-flex">
													<a href="${rootpath}admin/employee-edit/${employee.id}"
														...
														<div class="modal-dialog" role="document">
															<div class="modal-content">
																...
																<div class="modal-body">Do you want to delete this
																	record with id: ${employee.id} ?</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary"
																		data-dismiss="modal">Close</button>
																	<a
																		href="${rootpath}admin/employee-delete/${employee.id}"
