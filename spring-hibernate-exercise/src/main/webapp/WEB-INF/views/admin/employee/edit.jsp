...
<core:url value="/admin/employee-update" var="update" />
<core:url value="/" var="rootpath" />

<div class="container-fluid">
	<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Update Employee:
			${employee.name}</h1>
	...
	<div class="row">
		<div class="col-xl-12">
			...
			<frm:form action="${update}" modelAttribute="employee"
				...
				<div class="row g-3 mt-4 align-items-center">
					...
					<div class="col-auto">
						...
						<input type="file" name=fileAvatar /> <img width="100px"
