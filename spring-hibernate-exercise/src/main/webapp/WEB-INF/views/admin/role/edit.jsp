...
<core:url value="/admin/role-update" var="update" />
...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="${rootpath}admin/roles"
			class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
			class="fas fa-plus fa-sm text-white-50"></i> Add New Role</a>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<frm:form action="${update}" modelAttribute="role"
