...
<body>
	...
	<fm:form action="${update}" modelAttribute="person" method="POST"
		...
		<table border="1" cellspacing="3" cellpadding="5">
			...
			<tr>
				<th>Image:</th>
				<td><fm:input type="hidden" path="avatar" /> <img alt="Avatar"
					src="${p.avatar}"> <input type="file" name="fileAvatar" /><br />
					<fm:errors path="avatar" cssClass="error"></fm:errors></td>
			</tr>
			<tr>
				<th>Birthday :</th>
